...
#define Z_MAX_PIN          P1_28   // 10k pullup to 3.3V, 1K series
  ...
  #define Z_MIN_PROBE_PIN  P1_25   // Connector J8
#endif
...
#define TMC_USE_SW_SPI
  ...
  #define X_UART_ENABLE_PIN  P0_06
  #define Y_UART_ENABLE_PIN  P0_07
  #define Z_UART_ENABLE_PIN  P0_08
  #define E0_UART_ENABLE_PIN P0_09
  #define X_UART_INVERTING   false
  #define Y_UART_INVERTING   false
  #define Z_UART_INVERTING   false
  #define E0_UART_INVERTING  false
